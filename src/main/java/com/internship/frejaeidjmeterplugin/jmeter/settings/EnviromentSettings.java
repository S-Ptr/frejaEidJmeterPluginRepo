...
public class EnviromentSettings {
    ...
    private static final String PROJECT_PATH = "resources";
    ...
    public static void populateSettings() {
        switch (enviroment) {
            case SYSTEM_TEST:
                webSocketKeystorePath = PROJECT_PATH + Enviroment.SYSTEM_TEST.getName() + WEB_SOCKET_KEYSTORE_NAME;
                webSocketAdress = EnviromentAddress.SYSTEM_TEST_MOBILE_CLIENT.getUrl();
                relyingPartyKeystorePath = PROJECT_PATH + Enviroment.SYSTEM_TEST.getName() + RELYING_PARTY_KEYSTORE_NAME;
                serviceAddress = EnviromentAddress.SYSTEM_TEST_SERVICES.getUrl();
                break;
            case CUSTOMER_TEST:
                webSocketKeystorePath = PROJECT_PATH + Enviroment.CUSTOMER_TEST.getName() + WEB_SOCKET_KEYSTORE_NAME;
                webSocketAdress = EnviromentAddress.CUSTOMER_TEST_MOBILE_CLIENT.getUrl();
                relyingPartyKeystorePath = PROJECT_PATH + Enviroment.CUSTOMER_TEST.getName() + RELYING_PARTY_KEYSTORE_NAME;
                serviceAddress = EnviromentAddress.COSTUMER_TEST_SERVICES.getUrl();
                break;
            case PRODUCTION:
                webSocketKeystorePath = PROJECT_PATH + Enviroment.PRODUCTION.getName() + WEB_SOCKET_KEYSTORE_NAME;
                webSocketAdress = EnviromentAddress.PRODUCTION_MOBILE_CLIENT.getUrl();
                relyingPartyKeystorePath = PROJECT_PATH + Enviroment.PRODUCTION.getName() + RELYING_PARTY_KEYSTORE_NAME;
